...
- [ ] Refactor stinkiness!
- [x] Remove drag (player marker can be dragged around to move right now - just get rid of this completely)
- [x] Update point system (idk what it's supposed to do exactly but let's just say it should record the highest token the player has merged)
